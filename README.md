...
- [Double-Booking Prevention](DOUBLE_BOOKING_PREVENTION.md) - Race condition handling
- [Integrations Guide](INTEGRATIONS.md) - SMS, voice, webhooks setup
...
### Load Testing
See [PRODUCTION_CHECKLIST.md](PRODUCTION_CHECKLIST.md) for load testing scenarios.
