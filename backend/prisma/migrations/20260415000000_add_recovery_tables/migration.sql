-- CreateEnum
CREATE TYPE IF NOT EXISTS "RecoveryCaseState" AS ENUM ('ACTIVE', 'ENGAGED', 'RECOVERED', 'CLOSED_NO_RESPONSE', 'CLOSED_OPTED_OUT');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "MessageDirection" AS ENUM ('OUTBOUND', 'INBOUND');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "MessageStatus" AS ENUM ('QUEUED', 'SENT', 'DELIVERED', 'FAILED', 'RECEIVED');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "ActivityEventType" AS ENUM ('MISSED_CALL_DETECTED', 'OUTBOUND_SMS_QUEUED', 'OUTBOUND_SMS_SENT', 'OUTBOUND_SMS_DELIVERED', 'OUTBOUND_SMS_FAILED', 'INBOUND_SMS_RECEIVED', 'PATIENT_REPLIED', 'CASE_RECOVERED', 'CASE_CLOSED');
