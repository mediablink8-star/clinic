...
router.get('/config-status', asyncHandler(async (req, res) => {
    ...
    res.json({
        ...
        recovery: _workersModule ? _workersModule.isRunning : false,
...
router.get('/status', asyncHandler(async (req, res) => {
    ...
    const voiceConfigured = !!(clinic?.voiceEnabled && clinic?.vapiAssistantId && clinic?.vapiPhoneNumberId && (clinic?.zadarmaApiKey || process.env.ZADARMA_API_KEY));
    ...
    res.json({
        ...
        workerMode: _workersModule ? _workersModule.mode : 'unknown',
