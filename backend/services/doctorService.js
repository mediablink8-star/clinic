...
async function createDoctor({ clinicId, name, specialty, phone, email, workingHours, avgAppointmentValue }) {
    if (!name) {
    ...
    const doctor = await prisma.doctor.create({
        data: {
            ...
            avgAppointmentValue: avgAppointmentValue !== undefined ? avgAppointmentValue : undefined,
        }
    });
...
async function updateDoctor({ clinicId, doctorId, name, specialty, phone, email, workingHours, avatarUrl, avgAppointmentValue }) {
    ...
    const updated = await prisma.doctor.update({
        ...
        data: {
            ...
            avgAppointmentValue: avgAppointmentValue !== undefined ? avgAppointmentValue : existing.avgAppointmentValue,
        }
    });
