...
const amkaMessage = 'Το Α.Μ.Κ.Α. πρέπει να είναι ακριβώς 11 ψηφία.';
...
const patientSchema = Joi.object({
    ...
    amka: Joi.string().pattern(amkaRegex).allow(null, '').messages({
        'string.pattern.base': amkaMessage
    })
});
...
const appointmentSchema = Joi.object({
    ...
    doctorId: Joi.string().length(25).allow(null, ''),
