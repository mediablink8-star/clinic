    ...
    return (
        <div className="feed-container">
            ...
            <style>{`
                ...
                .feed-stats { display: flex; align-items: center; justify-content: space-around; padding: 18px 24px; background: var(--bg-subtle); border-radius: 16px; margin-bottom: 16px; flex-shrink: 0; }
                .stat-item { display: flex; flex-direction: column; align-items: center; gap: 4px; }
                .stat-value { font-size: 1.4rem; font-weight: 800; color: var(--text); }
                .stat-label { font-size: 0.7rem; font-weight: 600; color: var(--text-light); text-transform: uppercase; letter-spacing: 0.05em; }
                ...
                .feed-list { display: flex; flex-direction: column; gap: 14px; flex: 1; min-height: 0; overflow-y: auto; padding-right: 4px; }
                ...
                .feed-item { display: flex; align-items: center; gap: 16px; padding: 18px 20px; border-radius: 18px; background: var(--bg-card); border: 1px solid var(--border); cursor: pointer; transition: all 0.2s ease; position: relative; overflow: hidden; }
                ...
                .feed-status-bar { position: absolute; left: 0; top: 0; bottom: 0; width: 5px; }
                .feed-icon-wrapper { width: 50px; height: 50px; border-radius: 14px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; }
                
                .feed-content { flex: 1; min-width: 0; }
                .feed-main-row { display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px; }
                .feed-name-row { display: flex; align-items: center; gap: 8px; }
                .feed-name { font-size: 1.1rem; font-weight: 700; color: var(--text); white-space: nowrap; }
                .priority-icon { color: #ef4444; animation: flame 1s infinite; }
                @keyframes flame { 0%, 100% { opacity: 1; } 50% { opacity: 0.6; } }
                .feed-time { font-size: 0.8rem; color: var(--text-light); font-weight: 500; }
                .feed-sub-row { display: flex; align-items: center; gap: 10px; }
                .feed-preview { font-size: 0.9rem; color: #3b82f6; font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 220px; }
                .feed-phone { font-size: 0.9rem; color: var(--text-light); }
                
                .feed-right { display: flex; align-items: center; gap: 12px; flex-shrink: 0; }
                .badge-recovered { font-size: 0.9rem; font-weight: 800; padding: 8px 16px; border-radius: 20px; background: rgba(16,185,129,0.15); color: #059669; }
                .badge-recovering { font-size: 0.9rem; font-weight: 700; padding: 8px 16px; border-radius: 20px; background: rgba(59,130,246,0.15); color: #2563eb; }
                .btn-retry { width: 38px; height: 38px; border-radius: 50%; border: none; background: rgba(239,68,68,0.1); color: #dc2626; font-size: 1rem; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.2s; }
                ...
                .status-dot-wrapper { width: 14px; height: 14px; display: flex; align-items: center; justify-content: center; }
                .status-dot-small { width: 12px; height: 12px; border-radius: 50%; }
