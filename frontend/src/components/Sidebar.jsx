...
import { LayoutDashboard, Calendar, Users, TrendingUp, Settings, Brain, Plus, LogOut, Sun, Moon, X, BarChart2, CalendarCheck, ShieldAlert, ChevronLeft, ChevronRight, CreditCard } from 'lucide-react';
        ...
        },
        {
            ...
            items: [
                ...
                ...(clinic?.role === 'OWNER' || clinic?.role === 'ADMIN'
                    ? [{ id: 'billing', label: 'Συνδρομή', icon: CreditCard }]
                    : []),
            ]
        },
