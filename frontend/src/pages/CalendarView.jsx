    ...
    return (
        <div style={{ 
            ...
            <div style={{
                ...
                {/* Empty state when no appointments this month */}
                {appointments.length === 0 && (
                    <div style={{ textAlign: 'center', padding: '3rem 1rem', color: 'var(--text-light)' }}>
                        <p style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>📅</p>
                        <p style={{ fontWeight: '700', fontSize: '0.95rem', marginBottom: '0.25rem' }}>Δεν υπάρχουν ραντεβού ακόμα</p>
                        <p style={{ fontSize: '0.8rem' }}>Προσθέστε το πρώτο σας ραντεβού για να ξεκινήσετε</p>
                    </div>
                )}
            </div>
