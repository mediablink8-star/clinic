            ...
            <>
              ...
              <div style={{ textAlign: 'center', marginTop: '1.25rem' }}>
                <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.6)' }}>
                  Δεν έχετε ιατρείο; <button onClick={() => navigateTo('/demo-request')} style={{ background: 'none', border: 'none', padding: 0, color: 'var(--primary)', fontWeight: '700', cursor: 'pointer', textDecoration: 'none', outline: '2px solid transparent' }}>Ζητήστε επίδειξη</button>
                </p>
              </div>
