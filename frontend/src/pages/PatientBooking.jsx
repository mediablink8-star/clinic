                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.5rem' }}>
                                    ...
                                    <div>
                                        ...
                                        {!formData.date ? (
                                            ...
                                            <div style={{ padding: '2rem', textAlign: 'center', background: '#fff5f5', borderRadius: '16px', color: '#c53030', fontSize: '0.9rem', fontWeight: '700' }}>
                                                Δεν βρέθηκαν διαθέσιμα ραντεβού για αυτή την ημέρα
                                            </div>
                                        ) : (
